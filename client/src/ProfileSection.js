...
export const ProfileSection = () => {
  ...
  return (
    <div children={styles.dropDownContainer}>
        ...
        <div className={styles.frameDiv}>
          <div className={styles.frameDiv1}>
            ...
            >
              ...
              <MenuItem value="accommodation">accommodation</MenuItem> {/* <MenuItem onClick={handleChange} value="Accommodation">Accommodation</MenuItem> */}
