...
export const ProfileSection = () => {
 ...
 const [request, setRequest] = useState();
  ...
  const getRequestHandlerHelp = async () => {
    const response = await axios.get("https://hopetohands-wais.herokuapp.com/gethelper");
    console.log(response.data.data);
  ...
  const getRequestHandlerJob = async () => {
    const response = await axios.get("https://hopetohands-wais.herokuapp.com/getjob");
    console.log(response.data.data);
